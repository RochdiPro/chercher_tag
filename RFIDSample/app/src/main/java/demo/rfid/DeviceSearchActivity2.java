...
public class DeviceSearchActivity2 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_search2);
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (progressDialog != null && progressDialog.isShowing()) {
                            ...
                            Toast.makeText(DeviceSearchActivity2.this, R.string.string_device_search_cancel, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(DeviceSearchActivity2.this);
                    ...
                    .setPositiveButton("Déconnecter", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            final ProgressDialog progressDialog =
                                    ProgressDialog.show(DeviceSearchActivity2.this, "Déconnexion de l'appareil: " + deviceMacAddr, "S'il vous plaît, attendez.");
            ...
            builder.setTitle("Se connecter à l'appareil")
                    ...
                    .setPositiveButton("Relier", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            Handler handler = new Handler();
                            final ProgressDialog progressDialog =
                                    ProgressDialog.show(DeviceSearchActivity2.this, "Connexion de l'appareil: " + deviceMacAddr, "S'il vous plaît, attendez.");
                            handler.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    if (MainActivity.isConnected()) {
